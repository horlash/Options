# Security package
# Re-export Security class so `from backend.security import Security` works
# even though security/ is a package (which shadows the old security.py module).
...
class Security:
    ...
    def init_app(self, app):
        self.users_file = os.path.join(
            os.path.dirname(os.path.dirname(__file__)), 'users.json'
        )
        self.log_file = os.path.join(
            os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'access.log'
        )
