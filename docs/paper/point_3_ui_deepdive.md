...
## Analysis: Why "Update Portfolio Tab" over New "Paper" Tab?

### Option A: New "Paper Trade" Tab
*   **Pros:** Clean slate, no risk of breaking existing code.
*   **Cons:** Fragmented UI (User has to jump between two "Portfolios").

### Option B: Upgrade Existing Portfolio Tab (Selected)
*   **Pros:** Unified experience. "Paper" is just a mode/data source, not a separate location.
*   **Cons:** Requires refactoring existing `portfolio.js`.
*   **Verdict:** **Upgrade Existing.** It's cleaner UX.
